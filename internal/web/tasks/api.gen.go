...
type ServerInterface interface {
	...
	// Create a new task
	// (POST /tasks)
	AddTasks(ctx echo.Context) error
}
...
func (w *ServerInterfaceWrapper) AddTasks(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.AddTasks(ctx)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/tasks", wrapper.AddTasks)
...
func (sh *strictHandler) AddTasks(ctx echo.Context) error {
